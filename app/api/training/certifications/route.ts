  ...
  try {
    ...
    const transformedCertifications: ITrainingCertification[] = certifications.map((c: any) => ({
      ...
      asset: c.assetId?._id ? {
        ...
        status: (c.assetId as any).status || 'Active',
        serialNumber: (c.assetId as any).serialNumber || '',
        location: (c.assetId as any).location || '',
        purchaseDate: (c.assetId as any).purchaseDate?.toISOString() || '',
        nextPmDate: (c.assetId as any).nextPmDate?.toISOString() || '',
        value: (c.assetId as any).value || 0,
        createdAt: (c.assetId as any).createdAt?.toISOString() || '',
        updatedAt: (c.assetId as any).updatedAt?.toISOString() || '',
      } : undefined,
  ...
  try {
    ...
    const transformedCertification: ITrainingCertification = {
      ...
      asset: populatedCertification!.assetId?._id ? {
        ...
        name: (populatedCertification!.assetId as any).name || '',
        model: (populatedCertification!.assetId as any).model || '',
        manufacturer: (populatedCertification!.assetId as any).manufacturer || '',
        department: (populatedCertification!.assetId as any).department || '',
        status: (populatedCertification!.assetId as any).status || 'Active',
        serialNumber: (populatedCertification!.assetId as any).serialNumber || '',
        location: (populatedCertification!.assetId as any).location || '',
        purchaseDate: (populatedCertification!.assetId as any).purchaseDate?.toISOString() || '',
        nextPmDate: (populatedCertification!.assetId as any).nextPmDate?.toISOString() || '',
        value: (populatedCertification!.assetId as any).value || 0,
        createdAt: (populatedCertification!.assetId as any).createdAt?.toISOString() || '',
        updatedAt: (populatedCertification!.assetId as any).updatedAt?.toISOString() || '',
      } : undefined,
  ...
  try {
    ...
    const transformedCertification: ITrainingCertification = {
      ...
      asset: certification.assetId?._id ? {
        ...
        name: (certification.assetId as any).name || '',
        model: (certification.assetId as any).model || '',
        manufacturer: (certification.assetId as any).manufacturer || '',
        department: (certification.assetId as any).department || '',
        status: (certification.assetId as any).status || 'Active',
        serialNumber: (certification.assetId as any).serialNumber || '',
        location: (certification.assetId as any).location || '',
        purchaseDate: (certification.assetId as any).purchaseDate?.toISOString() || '',
        nextPmDate: (certification.assetId as any).nextPmDate?.toISOString() || '',
        value: (certification.assetId as any).value || 0,
        createdAt: (certification.assetId as any).createdAt?.toISOString() || '',
        updatedAt: (certification.assetId as any).updatedAt?.toISOString() || '',
      } : undefined,
